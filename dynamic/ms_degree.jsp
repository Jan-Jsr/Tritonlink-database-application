        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt.setString(2, request.getParameter("concen_name"));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE ms_degree SET concen_name = ?, concentration_units = ?, concentration_GPA = ?, degree_id = ? WHERE id = ?");

                        pstmt.setString(1, request.getParameter("concen_name"));
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="ms_degree.jsp" method="get">
                            ...
                            <th><input value="" name="concen_name" size="10"></th>
                    ...
                    <tr>
                        <form action="ms_degree.jsp" method="get">
                           ...
                           <%-- Get the id --%>
                            ...
                            <%-- Get the number --%>
                            <td>
                                <input value="<%= rs.getString("concen_name") %>"
                                    name="concen_name" size="15">
                            </td>
