    ...
    <table border="1">
        <tr>
            ...
            <%
                    ...
                    rs = statement.executeQuery("Select total_units from degree where name = '" + request.getParameter("degree_name")+"' and if_ms = 'NO'" );
                    ...
                    statement = conn.createStatement();
                    rs = statement.executeQuery("Select ld_units from degree where name = '" + request.getParameter("degree_name")+"' and if_ms = 'NO'");
                    ...
                    statement = conn.createStatement();
                    rs = statement.executeQuery("Select ud_units from degree where name = '" + request.getParameter("degree_name")+"' and if_ms = 'NO'");
                    ...
                    statement = conn.createStatement();
                    rs = statement.executeQuery("Select elective_units from degree where name = '" + request.getParameter("degree_name")+"' and if_ms = 'NO'");
                    

                    int total_electiveunits = 0;
                    while (rs.next()) {
                        total_electiveunits = rs.getInt("elective_units");
                    }
