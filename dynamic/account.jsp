        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE account SET password = ?, balance = ? WHERE stu_SSN = ?");

                        pstmt.setString(1, request.getParameter("password"));
                        pstmt.setInt(2, Integer.parseInt(request.getParameter("balance")));
                        pstmt.setInt(3, Integer.parseInt(request.getParameter("stu_SSN")));
            ...
            <%
                    ...
                    if (action != null && action.equals("delete")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "DELETE FROM account WHERE stu_SSN = ?");

                        pstmt.setInt(
                            1, Integer.parseInt(request.getParameter("stu_SSN")));
                        int rowCount = pstmt.executeUpdate();
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="account.jsp" method="get">
                            ...
                            <th><input value="" name="stu_SSN" size="10"></th>
