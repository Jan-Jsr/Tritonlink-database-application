        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt.setInt(5, Integer.parseInt(request.getParameter("en_limit")));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE section SET grade_scheme = ?, en_limit = ? WHERE id = ?");

                        pstmt.setString(1, request.getParameter("grade_scheme"));
                        pstmt.setInt(2, Integer.parseInt(request.getParameter("en_limit")));
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="sections.jsp" method="get">
                            ...
                            <th><input value="" name="en_limit" size="10"></th>
            ...
            %>
                    ...
                    <tr>
                        <form action="sections.jsp" method="get">
                            ...
                            <td>
                                <input value="<%= rs.getInt("en_limit") %>"
                                    name="en_limit" size="15">
                            </td>
