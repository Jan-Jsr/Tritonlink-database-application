        ...
        <tr>
            ...
            <%
                    ...
                    if (action != null && action.equals("insert")) {
                        ...
                        pstmt.setString(5, request.getParameter("grade_scheme"));
            ...
            <%
                    ...
                    if (action != null && action.equals("update")) {
                        ...
                        PreparedStatement pstmt = conn.prepareStatement(
                            "UPDATE course SET number = ?, department = ?, lab_work = ?,grade_scheme = ?, ld_ud = ?, elective = ?" +
                            "WHERE id = ?");

                        pstmt.setString(1, request.getParameter("number"));
                        pstmt.setString(2, request.getParameter("department"));
                        pstmt.setString(3, request.getParameter("lab_work"));
                        pstmt.setString(4, request.getParameter("grade_scheme"));
                        pstmt.setString(5, request.getParameter("ld_ud"));
                        pstmt.setString(6, request.getParameter("elective"));
                ...
                <table border="1">
                    ...
                    <tr>
                        <form action="courses.jsp" method="get">
                            ...
                            <th><input type = "radio" value="YES" name="lab_work" size="15">YES
                                <input type = "radio" value="NO" name="lab_work" size="15">NO</th>
                            <th><input type = "radio" value="S/U" name="grade_scheme" size="15">S/U
                                <input type = "radio" value="Letter" name="grade_scheme" size="15">Letter</th>
            ...
            %>
                    ...
                    <tr>
                        <form action="courses.jsp" method="get">
                            ...
                            <td>
                                <input value="<%= rs.getString("grade_scheme") %>"
                                    name="grade_scheme" size="15">
                            </td>
