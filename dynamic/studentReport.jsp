    ...
    <table border="1">
        <tr>
            ...
            <%
                    ...
                    ResultSet rs1 = statement1.executeQuery("with sec_id as(select * from learning where student_SSN = " + Integer.parseInt(request.getParameter("SSN")) + " and time_period = '2018-SPRING')" +
                    ...
                    ResultSet rs2 = statement2.executeQuery("Select * from learning where student_SSN = " + request.getParameter("SSN") + " and time_period = '2018-SPRING' ");
